...
export default function UserHeader() {
    return (
        <header className="flex items-center justify-between border-b bg-white h-14 px-4 gap-3 overflow-x-auto scrollbar-hide">
            <h1 className="text-xl font-bold shrink-0">OpenLabs</h1>
